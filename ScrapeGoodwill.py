...
page_list = asyncio.get_event_loop().run_until_complete(gwScrape())
...
for page in page_list:
    ...
    for item in allListings:
        try:
            ...
            print(name, price, time_remaining, img_url)
